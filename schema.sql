...
CREATE TABLE USERS_TRANSACTIONS (
  ...
  payer_id NUMERIC(25) REFERENCES USERS(id), 
  payee_id NUMERIC(25) REFERENCES USERS(id)
);
...
CREATE TABLE BALANCE (
  user_id NUMERIC(25) PRIMARY KEY REFERENCES USERS(id),
  amount NUMERIC(10,2)
);

CREATE TABLE FRIENDSHIPS (
  id SERIAL PRIMARY KEY,
  from_user NUMERIC(25) REFERENCES USERS(id),
  to_user NUMERIC(25) REFERENCES USERS(id),
...
INSERT INTO USERS (id, username, first_name, last_name, phone, password, email, avatar_url) VALUES (3, 'Will', 'Will', 'Putnam', 3333333333, 'password', 'wsputnam@wustl.edu', 'https://www.thesun.co.uk/wp-content/uploads/2017/02/nintchdbpict0002990093241.jpg?strip=all&w=960');
INSERT INTO USERS (id, username, first_name, last_name, phone, password, email, avatar_url) VALUES (4, 'Albert', 'Albert', 'Wong', 4444444444, 'password', 'albert@testing.org', 'https://s3-us-west-1.amazonaws.com/lawa-ig/images/null-2018-01-13T16%3A34%3A17-08%3A00.jpg');
